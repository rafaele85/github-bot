...
const testFixtures = (config) => [
    {
        githubData: {
            ...
            repository: { id: 355514042,
                ...
                subscription_url: 'https://api.github.com/repos/johnsmith/ppldo-task/subscription',
                commits_url: 'https://api.github.com/repos/johnsmith/ppldo-task/commits{/sha}',
                git_commits_url: 'https://api.github.com/repos/johnsmith/ppldo-task/git/commits{/sha}',
                comments_url: 'https://api.github.com/repos/johnsmith/ppldo-task/comments{/number}',
                issue_comment_url: 'https://api.github.com/repos/johnsmith/ppldo-task/issues/comments{/number}',
                contents_url: 'https://api.github.com/repos/johnsmith/ppldo-task/contents/{+path}',
                compare_url: 'https://api.github.com/repos/johnsmith/ppldo-task/compare/{base}...{head}',
                merges_url: 'https://api.github.com/repos/johnsmith/ppldo-task/merges',
                archive_url: 'https://api.github.com/repos/johnsmith/ppldo-task/{archive_format}{/ref}',
                downloads_url: 'https://api.github.com/repos/johnsmith/ppldo-task/downloads',
                issues_url: 'https://api.github.com/repos/johnsmith/ppldo-task/issues{/number}',
                pulls_url: 'https://api.github.com/repos/johnsmith/ppldo-task/pulls{/number}',
                milestones_url: 'https://api.github.com/repos/johnsmith/ppldo-task/milestones{/number}',
                notifications_url: 'https://api.github.com/repos/johnsmith/ppldo-task/notifications{?since,all,participating}',
                labels_url: 'https://api.github.com/repos/johnsmith/ppldo-task/labels{/name}',
                releases_url: 'https://api.github.com/repos/johnsmith/ppldo-task/releases{/id}',
                deployments_url: 'https://api.github.com/repos/johnsmith/ppldo-task/deployments',
            ...
            forced: false,
            base_ref: null,
            compare: 'https://github.com/johnsmith/ppldo-task/compare/3fd4274f372d...0a8953c3d55c',
            commits: [{ id: '0a8953c3d55c527028233c63392052e6aa0f2c44',
                    ...
                    url: 'https://github.com/johnsmith/ppldo-task/commit/0a8953c3d55c527028233c63392052e6aa0f2c44',
                    ...
                    removed: [],
                    modified: [] }],
            head_commit: { id: '0a8953c3d55c527028233c63392052e6aa0f2c44',
                tree_id: '6929afda019ea69da9d16bdb286abb34e6df4b1d',
                distinct: true,
